...
class MasterCatalogSeed {
  ...
  static const List<MasterCatalogItem> items = [
    ...
    MasterCatalogItem(barcode: '070330129668', name: 'قلم جاف بيك أزرق (Stylo Bic Cristal Bleu)', category: 'أدوات مدرسية ومكتبية', defaultPrice: 25.0, defaultCost: 18.0, wholesalePrice: 20.0), 
    MasterCatalogItem(barcode: '070330129675', name: 'قلم جاف بيك أحمر (Stylo Bic Cristal Rouge)', category: 'أدوات مدرسية ومكتبية', defaultPrice: 25.0, defaultCost: 18.0, wholesalePrice: 20.0), 
    MasterCatalogItem(barcode: '070330129682', name: 'قلم جاف بيك أسود (Stylo Bic Cristal Noir)', category: 'أدوات مدرسية ومكتبية', defaultPrice: 25.0, defaultCost: 18.0, wholesalePrice: 20.0), 
    MasterCatalogItem(barcode: '070330129699', name: 'قلم جاف بيك أخضر (Stylo Bic Cristal Vert)', category: 'أدوات مدرسية ومكتبية', defaultPrice: 25.0, defaultCost: 18.0, wholesalePrice: 20.0), 
    MasterCatalogItem(barcode: '6131101000641', name: 'كراس مدرسي 64 صفحة مسطر (Cahier 64p)', category: 'أدوات مدرسية ومكتبية', defaultPrice: 45.0, defaultCost: 35.0, wholesalePrice: 38.0), 
    MasterCatalogItem(barcode: '6131101000962', name: 'كراس مدرسي 96 صفحة مسطر (Cahier 96p)', category: 'أدوات مدرسية ومكتبية', defaultPrice: 65.0, defaultCost: 50.0, wholesalePrice: 55.0), 
    MasterCatalogItem(barcode: '6131101001204', name: 'كراس مدرسي 120 صفحة مسطر (Cahier 120p)', category: 'أدوات مدرسية ومكتبية', defaultPrice: 90.0, defaultCost: 72.0, wholesalePrice: 78.0), 
    ...
    MasterCatalogItem(barcode: '6131102000101', name: 'ممحاة مدرسية بيضاء كلاسيك (Gomme blanche)', category: 'أدوات مدرسية ومكتبية', defaultPrice: 20.0, defaultCost: 12.0, wholesalePrice: 15.0), 
