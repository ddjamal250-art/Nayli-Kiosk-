...
class _EditProductPageState extends State<EditProductPage> {
  ...
  late TextEditingController _customQuantityCtrl;
  late TextEditingController _customQuantityPriceCtrl;
  late TextEditingController _customQuantityLabelCtrl;
  late bool _hasCustomQuantityPricing;
  ...
  void initState() {
    ...
    _cartonBarcodeCtrl = TextEditingController(text: widget.product.cartonBarcode ?? '');
    _hasCustomQuantityPricing = widget.product.packMultiplier > 1 && widget.product.packPrice > 0;
    _customQuantityCtrl = TextEditingController(text: widget.product.packMultiplier > 1 ? widget.product.packMultiplier.toString() : '3');
    _customQuantityPriceCtrl = TextEditingController(text: widget.product.packPrice > 0 ? widget.product.packPrice.toStringAsFixed(0) : '100');
    _customQuantityLabelCtrl = TextEditingController(text: widget.product.packName ?? '');
